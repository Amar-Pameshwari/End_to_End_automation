...
public class BusLocationFind 
{
	...
	public static void BusStopLocationFind()
	{
		...
		JSONObject jsonObjectResponse = Utilities_jsonPath_asString.jsonObjectParser(getStringResponse);
		//JsonPath jsonResponse = Utilities_jsonPath_asString.jsonGetParser(getStringResponse);
	...
	String wheelchairBoarding = JsonObject_TestUtils.getValueByJPath(jsonObjectResponse, "/data/stops[0]/wheelchairBoarding");
		...
		String Stops0_locationType = JsonObject_TestUtils.getValueByJPath(jsonObjectResponse, "/data/stops[0]/locationType");
		...
		String Stops0_agency_id = JsonObject_TestUtils.getValueByJPath(jsonObjectResponse, "/data/stops[0]/routes[0]/agency/id");
		log.info("Stops[0]-routes[0]_ agency_id : " + Stops0_agency_id);
		
		String Stops0_routes0_id = JsonObject_TestUtils.getValueByJPath(jsonObjectResponse, "/data/stops[0]/routes[0]/id");
